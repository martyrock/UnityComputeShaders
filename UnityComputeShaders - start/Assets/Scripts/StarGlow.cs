...
public class StarGlow : MonoBehaviour
{
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        RenderTexture brightnessTex = RenderTexture.GetTemporary(source.width / divide,
            source.height / divide, source.depth, source.format);
        ...
        {
            Vector2 offset = (Quaternion.AngleAxis(angle * x + angleOfStreak, Vector3.forward)
            ...
            Graphics.Blit(blurredTex2, compositeTex, material, 3);
        }
